...
#' Coupled with natrual spline function.
#'
...
#' permut_out <- SEpermut_ns(fit_spline_out_df,sample_pool,c1_n=2,c2_n=2)
#'
#' # permutation 5 times
#' permut_out <- SEpermut_ns(fit_spline_out_df,sample_pool,times=5,c1_n=2,c2_n=2)
#'
#' # no permutation
#' permut_out <- SEpermut_ns(fit_spline_out_df,sample_pool,permut=F,c1_n=2,c2_n=2)

SEpermut_ns <- function(spline_fit_out,sample_pool,permut=T,times=10,c1_n,c2_n) {
