...
![spline compare figuers.](spline_comparison.png){width=80%}
...
```{r, density_plot,fig.show = "hold",fig.width=4,fig.height=4,fig.align="center"}
...
```{r, pattern_example,fig.show = "hold",fig.width=4,fig.height=4,fig.align="center"}
