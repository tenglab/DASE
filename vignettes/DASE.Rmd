...
is shown below.  The count table is adapted with parameter *enhancer_count_table*.
...
The output of _DASE_ is a list with multiple data types including:
  ...
  1. lfc_shrink: a shrinking lfc object from DESeq2. It can be used to creat MA plot
  ...
  1. se_fit: a data frame containing DESeq2 output and spline-fitted log2 fold change of all constitute enhancers
...
disabled, the default significant threshold is -1 and 1. You can also choose your own thresholds with 
...
*SE_category, pattern_list, se_fit* are the outputs related to SE internal dynamics.
